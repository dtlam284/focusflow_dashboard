...
//#region component
export function NotePreviewDialog({ note, open, onOpenChange, onEdit }: INotePreviewDialogProps) {
  if (!note) return null
      ...
      <DialogContent className="max-w-2xl overflow-hidden p-0">
        ...
        >
          <DialogHeader className="border-b border-slate-200 px-6 py-5 dark:border-slate-800">
            ...
            <DialogDescription className="sr-only">Note preview</DialogDescription>
          </DialogHeader>
